...
//S3C2410_ADDR(0x01800000)
#define SMDK2410_ETH_IRQ   IRQ_EINT9


static unsigned int __initdata netcard_portlist[]= { vSMDK2410_ETH_IO + DEFAULTIOBASE, 0};
...
cs89x0_probe1(struct net_device *dev, int ioaddr, int modular)
{
	...
	if (!request_region(ioaddr & ~3, 0xfff, DRV_NAME)) {
	...
	if (tmp != CHIP_EISA_ID_SIG) {
		printk( "%s: incorrect signature at %x[%x]: 0x%x!="
